...
-- ----------------------------
INSERT INTO `greeting_card` VALUES (1, '上班卡', 'sun-card', '0 0 8 * * ?', '8:00');
INSERT INTO `greeting_card` VALUES (2, '下班卡', 'moon-card', '0 50 17 * * ?', '17:50');
...
CREATE TABLE `person`  (
  ...
  `district_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '区代码',
...
-- Records of service
-- ----------------------------
INSERT INTO `service` VALUES (1, '天气预报', 'WeatherService', 0, 0);
INSERT INTO `service` VALUES (2, '舔狗日记', 'DogDiaryService', 1, 2);
INSERT INTO `service` VALUES (3, '正能量', 'PositiveEnergyService', 1, 3);
INSERT INTO `service` VALUES (4, '毒鸡汤', 'NegativeEnergyService', 1, 4);
INSERT INTO `service` VALUES (5, '每日一语', 'EveryDaySentenceService', 1, 5);
INSERT INTO `service` VALUES (6, '彩虹屁', 'RainbowFartService', 1, 6);
INSERT INTO `service` VALUES (7, '朋友圈', 'CircleOfFriendsService', 1, 7);
INSERT INTO `service` VALUES (8, '网易云', 'NeteaseCloudService', 1, 8);
INSERT INTO `service` VALUES (9, '自定义（未开通）', 'CustomerService', 1, 10);
